...
function get_price_bord(){
    ...
    echo'
       ...
       <p><strong>Stoelen legenda</strong></p>
        <p>De kleuren van de stoelen hebben een prijs of een betekenis</p>
     <div class="price_bord_row">   
           <div class="cinema_chair_blue"></div><p>&nbsp; &euro; '.number_format($stoel_blauw['prijs'],2).'</p>
        </div>
     <div class="price_bord_row">               
           <div class="cinema_chair_yellow"></div><p>&nbsp; &euro; '.number_format($stoel_geel_of_oranje['prijs'],2).'</p>
     </div>
     <div class="price_bord_row">             
           <div class="cinema_chair_red"></div><p> &nbsp; &euro; '.number_format($stoel_rood['prijs'],2).'</p>
     </div>
     <div class="price_bord_row">   
           <div class="cinema_chair_taken"></div><p>&nbsp; Gereserveerd</p>
     </div>
     <div class="price_bord_row">   
           <div class="cinema_chair_explain"></div><p>&nbsp; Gekozen stoel</p>
     </div>
        </div>
        ';
